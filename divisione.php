...
<form action="" method="post">
    ...
    <input type="text" id="lDivisore" name="lDivisore" value="<?=$input2?>">
...
function divisione($n1 = 1345, $n2 = 2.1) {
...
// $page = scrivi($page,0,-strlen($k1)+1,str_repeat('-',strlen($k1)+$num_cifre_out+3));
$page = scrivi($page,0,2,str_repeat('-',$num_cifre_out+3));
...
for ($i_level=1;$i_level<=$num_cifre_out;$i_level++) {
    ...
    $page = scrivi($page,$riga_base+2,2,"|");
    ...
    $page = scrivi($page,$riga_base+2,$col_abbasso+2-strlen($ks_resto),$ks_resto);
